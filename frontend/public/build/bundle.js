...
var app = (function (exports) {
    ...
    function create_else_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$9, 43, 24, 1562);
    		},
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$9, 41, 24, 1404);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    class Landing extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { onload: 2 });
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$7, 26, 8, 687);
    			attr_dev(label, "id", "usernameLabel");
    			attr_dev(label, "for", "usernameInput");
    			add_location(label, file$7, 27, 8, 883);
    			attr_dev(input1, "type", "hidden");
    			attr_dev(input1, "name", "room");
    			attr_dev(input1, "id", "roomIDInput");
    			add_location(input1, file$7, 28, 8, 974);
    			attr_dev(div0, "class", "nine columns");
    			add_location(div0, file$7, 25, 4, 651);
    			...
    			add_location(button, file$7, 31, 8, 1108);
    			attr_dev(div1, "class", "three columns");
    			add_location(div1, file$7, 30, 4, 1071);
    			attr_dev(div2, "class", "row");
    			set_style(div2, "margin-top", "15%");
    			add_location(div2, file$7, 24, 0, 595);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*setLobby*/ ctx[1], false, false, false)
    				];
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "autocomplete", "off");
    			input0.required = true;
    			add_location(input0, file$6, 26, 8, 748);
    			attr_dev(label0, "for", "usernameInput");
    			add_location(label0, file$6, 27, 8, 944);
    			attr_dev(div0, "class", "five columns");
    			add_location(div0, file$6, 25, 4, 712);
    			...
    			add_location(input1, file$6, 30, 8, 1060);
    			attr_dev(label1, "for", "roomIdInput");
    			add_location(label1, file$6, 31, 8, 1244);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$6, 29, 4, 1024);
    			attr_dev(button, "class", "button-primary button-submit u-full-width");
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "id", "submitButton");
    			set_style(button, "transition", "500ms");
    			add_location(button, file$6, 34, 8, 1357);
    			attr_dev(div2, "class", "three columns");
    			add_location(div2, file$6, 33, 4, 1320);
    			attr_dev(div3, "class", "row");
    			set_style(div3, "margin-top", "15%");
    			add_location(div3, file$6, 24, 0, 656);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "input", /*input0_input_handler*/ ctx[2]),
    					listen_dev(input1, "input", /*input1_input_handler*/ ctx[3]),
    					listen_dev(button, "click", /*validate*/ ctx[1], false, false, false)
    				];
    ...
    const file$5 = "src\\Button_Estimation.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 22, 4, 617);
    			attr_dev(div, "class", "two columns");
    			add_location(div, file$5, 21, 0, 586);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src\\Banner.svelte";
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$4, 10, 4, 209);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$4, 8, 4, 143);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h4, anchor);
    			append_dev(h4, t);
    ...
    class Banner extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { msg: 0, transition: 1 });
    ...
    /* src\Userdetails.svelte generated by Svelte v3.35.0 */

    const file$3 = "src\\Userdetails.svelte";
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$3, 15, 8, 329);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 12, 12, 221);
    			attr_dev(td, "class", "estimation");
    			add_location(td, file$3, 11, 8, 184);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, img);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$3, 9, 4, 130);
    			add_location(tr, file$3, 8, 0, 120);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\Modal_Leave.svelte generated by Svelte v3.35.0 */
    const file$2 = "src\\Modal_Leave.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 17, 12, 425);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$2, 16, 8, 394);
    			attr_dev(button0, "class", "button-primary-join u-full-width");
    			add_location(button0, file$2, 21, 16, 662);
    			attr_dev(div2, "class", "six columns");
    			add_location(div2, file$2, 20, 12, 619);
    			attr_dev(button1, "class", "button-primary-negative u-full-width");
    			add_location(button1, file$2, 24, 16, 817);
    			attr_dev(div3, "class", "six columns");
    			add_location(div3, file$2, 23, 12, 774);
    			attr_dev(div4, "class", "row");
    			add_location(div4, file$2, 19, 8, 588);
    			attr_dev(div5, "class", "container");
    			add_location(div5, file$2, 15, 4, 361);
    			attr_dev(div6, "class", "modal");
    			attr_dev(div6, "id", "modal");
    			add_location(div6, file$2, 14, 0, 309);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(157:12) {#if bannerIsVisible}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(183:20) {#each allUsers as user}",
    		ctx
    	});
    ...
    // (205:8) {#each firstRowValues as currentValue}
    function create_each_block_1(ctx) {
    	...
    	button_estimation.$on("setEstimation", /*setEstimation*/ ctx[12]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(205:8) {#each firstRowValues as currentValue}",
    		ctx
    	});
    ...
    // (210:8) {#each secondRowValues as currentValue}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(210:8) {#each secondRowValues as currentValue}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block1 = /*modal*/ ctx[5] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img1, file$1, 164, 16, 4954);
    			attr_dev(button0, "class", "button-primary-join u-full-width");
    			set_style(button0, "display", "grid");
    			set_style(button0, "place-items", "center");
    			add_location(button0, file$1, 163, 12, 4820);
    			attr_dev(div3, "class", "two columns");
    			add_location(div3, file$1, 162, 8, 4781);
    			attr_dev(button1, "class", "button-primary-negative u-full-width");
    			add_location(button1, file$1, 168, 12, 5101);
    			attr_dev(div4, "class", "two columns");
    			add_location(div4, file$1, 167, 8, 5062);
    			attr_dev(div5, "class", "row");
    			set_style(div5, "margin-top", "15%");
    			add_location(div5, file$1, 146, 4, 4100);
    			add_location(th0, file$1, 177, 24, 5421);
    			add_location(th1, file$1, 178, 24, 5463);
    			add_location(tr0, file$1, 176, 20, 5391);
    			add_location(thead, file$1, 175, 16, 5362);
    			add_location(td0, file$1, 189, 24, 5928);
    			attr_dev(td1, "id", "AuMgIVUHfSHpDpgMAAAB");
    			set_style(td1, "color", "#FCA311");
    			add_location(td1, file$1, 190, 24, 5970);
    			add_location(tr1, file$1, 188, 20, 5898);
    			attr_dev(tbody, "id", "playerlist");
    			add_location(tbody, file$1, 181, 16, 5553);
    			attr_dev(table, "class", "u-full-width");
    			add_location(table, file$1, 174, 12, 5316);
    			attr_dev(div6, "class", "four columns");
    			add_location(div6, file$1, 173, 8, 5276);
    			add_location(h41, file$1, 196, 12, 6178);
    			attr_dev(div7, "class", "four columns");
    			add_location(div7, file$1, 195, 8, 6138);
    			add_location(h42, file$1, 199, 12, 6255);
    			attr_dev(div8, "class", "three columns");
    			add_location(div8, file$1, 198, 8, 6214);
    			attr_dev(div9, "class", "row");
    			set_style(div9, "margin-top", "5%");
    			add_location(div9, file$1, 172, 4, 5225);
    			attr_dev(div10, "class", "row");
    			set_style(div10, "margin-top", "5%");
    			add_location(div10, file$1, 203, 4, 6301);
    			attr_dev(div11, "class", "row lowerrow");
    			add_location(div11, file$1, 208, 4, 6509);
    			attr_dev(div12, "class", "content");
    			add_location(div12, file$1, 145, 0, 4065);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(img0, "click", /*copyRoomID*/ ctx[11], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*firstRowValues, setEstimation*/ 4160) {
    			...
    			if (dirty & /*secondRowValues, setEstimation*/ 4224) {
