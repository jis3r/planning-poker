...
var app = (function (exports) {
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$5, 15, 8, 303);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$5, 13, 8, 232);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$5, 22, 8, 513);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 19, 12, 405);
    			attr_dev(td, "class", "estimation");
    			add_location(td, file$5, 18, 8, 368);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, img);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			if_block1.c();
    			add_location(tr, file$5, 11, 0, 191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(174:12) {#if bannerIsVisible}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(200:20) {#each allUsers as user}",
    		ctx
    	});
    ...
    // (223:8) {#each firstRowValues as currentValue}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(223:8) {#each firstRowValues as currentValue}",
    		ctx
    	});
    ...
    // (228:8) {#each secondRowValues as currentValue}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(228:8) {#each secondRowValues as currentValue}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$2, 169, 16, 4919);
    			attr_dev(div0, "class", "copyicon u-pull-left");
    			add_location(div0, file$2, 168, 12, 4867);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$2, 166, 8, 4785);
    			attr_dev(div2, "class", "four columns");
    			attr_dev(div2, "id", "bannerfield");
    			add_location(div2, file$2, 172, 8, 5023);
    			...
    			add_location(img1, file$2, 181, 16, 5476);
    			attr_dev(button0, "class", "button-primary-join u-full-width");
    			set_style(button0, "display", "grid");
    			set_style(button0, "place-items", "center");
    			attr_dev(button0, "onclick", "this.blur();");
    			add_location(button0, file$2, 180, 12, 5319);
    			attr_dev(div3, "class", "two columns");
    			add_location(div3, file$2, 179, 8, 5280);
    			attr_dev(button1, "class", "button-primary-negative u-full-width");
    			add_location(button1, file$2, 185, 12, 5623);
    			attr_dev(div4, "class", "two columns");
    			add_location(div4, file$2, 184, 8, 5584);
    			attr_dev(div5, "class", "row");
    			set_style(div5, "margin-top", "15%");
    			add_location(div5, file$2, 165, 4, 4733);
    			add_location(th0, file$2, 194, 24, 5943);
    			add_location(th1, file$2, 195, 24, 5985);
    			add_location(tr0, file$2, 193, 20, 5913);
    			add_location(thead, file$2, 192, 16, 5884);
    			add_location(td0, file$2, 207, 24, 6504);
    			attr_dev(td1, "id", "AuMgIVUHfSHpDpgMAAAB");
    			set_style(td1, "color", "#FCA311");
    			add_location(td1, file$2, 208, 24, 6546);
    			add_location(tr1, file$2, 206, 20, 6474);
    			attr_dev(tbody, "id", "playerlist");
    			add_location(tbody, file$2, 198, 16, 6075);
    			attr_dev(table, "class", "u-full-width");
    			add_location(table, file$2, 191, 12, 5838);
    			attr_dev(div6, "class", "four columns");
    			add_location(div6, file$2, 190, 8, 5798);
    			add_location(h40, file$2, 214, 12, 6754);
    			attr_dev(div7, "class", "four columns");
    			add_location(div7, file$2, 213, 8, 6714);
    			add_location(h41, file$2, 217, 12, 6831);
    			attr_dev(div8, "class", "three columns");
    			add_location(div8, file$2, 216, 8, 6790);
    			attr_dev(div9, "class", "row");
    			set_style(div9, "margin-top", "5%");
    			add_location(div9, file$2, 189, 4, 5747);
    			attr_dev(div10, "class", "row");
    			set_style(div10, "margin-top", "5%");
    			add_location(div10, file$2, 221, 4, 6877);
    			attr_dev(div11, "class", "row lowerrow");
    			add_location(div11, file$2, 226, 4, 7085);
    			attr_dev(div12, "class", "content");
    			add_location(div12, file$2, 164, 0, 4698);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
