    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$6, 41, 20, 1360);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$6, 39, 20, 1246);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$4, 23, 8, 531);
    			attr_dev(label, "for", "usernameInput");
    			add_location(label, file$4, 24, 8, 727);
    			attr_dev(input1, "type", "hidden");
    			attr_dev(input1, "name", "room");
    			attr_dev(input1, "id", "roomIDInput");
    			add_location(input1, file$4, 25, 8, 799);
    			attr_dev(div0, "class", "nine columns");
    			add_location(div0, file$4, 22, 4, 495);
    			attr_dev(button, "class", "button-primary button-submit u-full-width");
    			attr_dev(button, "type", "submit");
    			add_location(button, file$4, 28, 8, 933);
    			attr_dev(div1, "class", "three columns");
    			add_location(div1, file$4, 27, 4, 896);
    			attr_dev(div2, "class", "row");
    			set_style(div2, "margin-top", "15%");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "autocomplete", "off");
    			input0.required = true;
    			add_location(input0, file$3, 22, 8, 578);
    			attr_dev(label0, "for", "usernameInput");
    			add_location(label0, file$3, 23, 8, 774);
    			attr_dev(div0, "class", "five columns");
    			add_location(div0, file$3, 21, 4, 542);
    			...
    			add_location(input1, file$3, 26, 8, 890);
    			attr_dev(label1, "for", "roomIdInput");
    			add_location(label1, file$3, 27, 8, 1074);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$3, 25, 4, 854);
    			attr_dev(button, "class", "button-primary button-submit u-full-width");
    			attr_dev(button, "type", "submit");
    			add_location(button, file$3, 30, 8, 1187);
    			attr_dev(div2, "class", "three columns");
    			add_location(div2, file$3, 29, 4, 1150);
