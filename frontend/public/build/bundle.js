...
var app = (function (exports) {
    ...
    function create_else_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 44, 24, 1571);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 42, 24, 1413);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(163:12) {#if bannerIsVisible}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(189:20) {#each allUsers as user}",
    		ctx
    	});
    ...
    // (212:8) {#each firstRowValues as currentValue}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(212:8) {#each firstRowValues as currentValue}",
    		ctx
    	});
    ...
    // (217:8) {#each secondRowValues as currentValue}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(217:8) {#each secondRowValues as currentValue}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$2, 158, 16, 4596);
    			attr_dev(div0, "class", "copyicon u-pull-left");
    			add_location(div0, file$2, 157, 12, 4544);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$2, 155, 8, 4462);
    			attr_dev(div2, "class", "four columns");
    			attr_dev(div2, "id", "bannerfield");
    			add_location(div2, file$2, 161, 8, 4700);
    			...
    			add_location(img1, file$2, 170, 16, 5130);
    			attr_dev(button0, "class", "button-primary-join u-full-width");
    			set_style(button0, "display", "grid");
    			set_style(button0, "place-items", "center");
    			add_location(button0, file$2, 169, 12, 4996);
    			attr_dev(div3, "class", "two columns");
    			add_location(div3, file$2, 168, 8, 4957);
    			attr_dev(button1, "class", "button-primary-negative u-full-width");
    			add_location(button1, file$2, 174, 12, 5277);
    			attr_dev(div4, "class", "two columns");
    			add_location(div4, file$2, 173, 8, 5238);
    			attr_dev(div5, "class", "row");
    			set_style(div5, "margin-top", "15%");
    			add_location(div5, file$2, 154, 4, 4410);
    			add_location(th0, file$2, 183, 24, 5597);
    			add_location(th1, file$2, 184, 24, 5639);
    			add_location(tr0, file$2, 182, 20, 5567);
    			add_location(thead, file$2, 181, 16, 5538);
    			add_location(td0, file$2, 196, 24, 6158);
    			attr_dev(td1, "id", "AuMgIVUHfSHpDpgMAAAB");
    			set_style(td1, "color", "#FCA311");
    			add_location(td1, file$2, 197, 24, 6200);
    			add_location(tr1, file$2, 195, 20, 6128);
    			attr_dev(tbody, "id", "playerlist");
    			add_location(tbody, file$2, 187, 16, 5729);
    			attr_dev(table, "class", "u-full-width");
    			add_location(table, file$2, 180, 12, 5492);
    			attr_dev(div6, "class", "four columns");
    			add_location(div6, file$2, 179, 8, 5452);
    			add_location(h40, file$2, 203, 12, 6408);
    			attr_dev(div7, "class", "four columns");
    			add_location(div7, file$2, 202, 8, 6368);
    			add_location(h41, file$2, 206, 12, 6485);
    			attr_dev(div8, "class", "three columns");
    			add_location(div8, file$2, 205, 8, 6444);
    			attr_dev(div9, "class", "row");
    			set_style(div9, "margin-top", "5%");
    			add_location(div9, file$2, 178, 4, 5401);
    			attr_dev(div10, "class", "row");
    			set_style(div10, "margin-top", "5%");
    			add_location(div10, file$2, 210, 4, 6531);
    			attr_dev(div11, "class", "row lowerrow");
    			add_location(div11, file$2, 215, 4, 6739);
    			attr_dev(div12, "class", "content");
    			add_location(div12, file$2, 153, 0, 4375);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
