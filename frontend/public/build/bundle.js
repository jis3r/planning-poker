...
var app = (function () {
    ...
    function create_else_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$a, 25, 4, 646);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$a, 23, 4, 550);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$a, 27, 4, 746);
    			set_style(div, "cursor", "pointer");
    			add_location(div, file$a, 21, 0, 464);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<Checkbox_Spectator> was created with unknown prop '${key}'`);
    	});
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "autocomplete", "off");
    			input0.required = true;
    			add_location(input0, file$8, 54, 12, 1843);
    			attr_dev(label0, "id", "usernameLabel");
    			attr_dev(label0, "for", "usernameInput");
    			add_location(label0, file$8, 55, 12, 2034);
    			attr_dev(div0, "class", "five columns");
    			add_location(div0, file$8, 53, 8, 1803);
    			...
    			add_location(input1, file$8, 58, 12, 2181);
    			attr_dev(label1, "id", "roomidLabel");
    			attr_dev(label1, "for", "roomIdInput");
    			add_location(label1, file$8, 59, 12, 2360);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$8, 57, 8, 2141);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "autocomplete", "off");
    			input0.required = true;
    			add_location(input0, file$8, 48, 12, 1408);
    			attr_dev(label, "id", "usernameLabel");
    			attr_dev(label, "for", "usernameInput");
    			add_location(label, file$8, 49, 12, 1599);
    			attr_dev(input1, "type", "hidden");
    			attr_dev(input1, "name", "room");
    			attr_dev(input1, "id", "roomIDInput");
    			add_location(input1, file$8, 50, 12, 1694);
    			attr_dev(div, "class", "nine columns");
    			add_location(div, file$8, 47, 8, 1368);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "id", "submitButton");
    			set_style(button, "transition", "500ms");
    			add_location(button, file$8, 63, 8, 2505);
    			attr_dev(div0, "class", "three columns");
    			add_location(div0, file$8, 62, 4, 2468);
    			attr_dev(div1, "class", "row");
    			set_style(div1, "margin-top", "15%");
    			add_location(div1, file$8, 45, 0, 1291);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
