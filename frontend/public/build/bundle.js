...
var app = (function () {
    ...
    function create_else_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 56, 24, 2038);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 54, 24, 1880);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$9, 31, 8, 885);
    			attr_dev(label, "id", "usernameLabel");
    			attr_dev(label, "for", "usernameInput");
    			add_location(label, file$9, 32, 8, 1081);
    			attr_dev(input1, "type", "hidden");
    			attr_dev(input1, "name", "room");
    			attr_dev(input1, "id", "roomIDInput");
    			add_location(input1, file$9, 33, 8, 1172);
    			attr_dev(div0, "class", "nine columns");
    			add_location(div0, file$9, 30, 4, 849);
    			...
    			add_location(button, file$9, 36, 8, 1306);
    			attr_dev(div1, "class", "three columns");
    			add_location(div1, file$9, 35, 4, 1269);
    			attr_dev(div2, "class", "row");
    			set_style(div2, "margin-top", "15%");
    			add_location(div2, file$9, 29, 0, 793);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "autocomplete", "off");
    			input0.required = true;
    			add_location(input0, file$8, 49, 12, 1817);
    			attr_dev(label0, "for", "usernameInput");
    			add_location(label0, file$8, 50, 12, 2017);
    			attr_dev(div0, "class", "five columns");
    			add_location(div0, file$8, 48, 8, 1777);
    			...
    			add_location(input1, file$8, 53, 12, 2145);
    			attr_dev(label1, "for", "roomIdInput");
    			add_location(label1, file$8, 54, 12, 2333);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$8, 52, 8, 2105);
    			attr_dev(button, "class", "button-primary button-submit u-full-width");
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "id", "submitButton");
    			set_style(button, "transition", "500ms");
    			add_location(button, file$8, 57, 12, 2458);
    			attr_dev(div2, "class", "three columns");
    			add_location(div2, file$8, 56, 8, 2417);
    			attr_dev(div3, "class", "row");
    			set_style(div3, "margin-top", "15%");
    			add_location(div3, file$8, 47, 4, 1717);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "autocomplete", "off");
    			input0.required = true;
    			add_location(input0, file$8, 38, 12, 1084);
    			attr_dev(label, "id", "usernameLabel");
    			attr_dev(label, "for", "usernameInput");
    			add_location(label, file$8, 39, 12, 1284);
    			attr_dev(input1, "type", "hidden");
    			attr_dev(input1, "name", "room");
    			attr_dev(input1, "id", "roomIDInput");
    			add_location(input1, file$8, 40, 12, 1379);
    			attr_dev(div0, "class", "nine columns");
    			add_location(div0, file$8, 37, 8, 1044);
    			attr_dev(button, "class", "button-primary button-submit u-full-width");
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "id", "submitButton");
    			set_style(button, "transition", "500ms");
    			add_location(button, file$8, 43, 12, 1525);
    			attr_dev(div1, "class", "three columns");
    			add_location(div1, file$8, 42, 8, 1484);
    			attr_dev(div2, "class", "row");
    			set_style(div2, "margin-top", "15%");
    			add_location(div2, file$8, 36, 4, 984);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div0);
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$5, 20, 8, 476);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 17, 12, 368);
    			attr_dev(td, "class", "estimation");
    			add_location(td, file$5, 16, 8, 331);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, img);
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(173:12) {#if bannerIsVisible}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	userdetails = new Userdetails({
    			props: {
    				name: /*user*/ ctx[27].username,
    				id: /*user*/ ctx[27].id,
    				estimation: /*user*/ ctx[27].estimation,
    				isReady: /*user*/ ctx[27].isReady,
    				socketid: socket.id
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*allUsers*/ 8) userdetails_changes.name = /*user*/ ctx[27].username;
    			if (dirty & /*allUsers*/ 8) userdetails_changes.id = /*user*/ ctx[27].id;
    			if (dirty & /*allUsers*/ 8) userdetails_changes.estimation = /*user*/ ctx[27].estimation;
    			if (dirty & /*allUsers*/ 8) userdetails_changes.isReady = /*user*/ ctx[27].isReady;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(199:20) {#each allUsers as user}",
    		ctx
    	});
    ...
    // (222:8) {#each firstRowValues as currentValue}
    function create_each_block_1(ctx) {
    	let button_estimation;
    	let current;

    	button_estimation = new Button_Estimation({
    			props: { value: /*currentValue*/ ctx[22] },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(222:8) {#each firstRowValues as currentValue}",
    		ctx
    	});
    ...
    // (227:8) {#each secondRowValues as currentValue}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(227:8) {#each secondRowValues as currentValue}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$2, 168, 16, 4909);
    			attr_dev(div0, "class", "copyicon u-pull-left");
    			add_location(div0, file$2, 167, 12, 4857);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$2, 165, 8, 4775);
    			attr_dev(div2, "class", "four columns");
    			attr_dev(div2, "id", "bannerfield");
    			add_location(div2, file$2, 171, 8, 5013);
    			...
    			add_location(img1, file$2, 180, 16, 5466);
    			attr_dev(button0, "class", "button-primary-join u-full-width");
    			set_style(button0, "display", "grid");
    			set_style(button0, "place-items", "center");
    			attr_dev(button0, "onclick", "this.blur();");
    			add_location(button0, file$2, 179, 12, 5309);
    			attr_dev(div3, "class", "two columns");
    			add_location(div3, file$2, 178, 8, 5270);
    			attr_dev(button1, "class", "button-primary-negative u-full-width");
    			add_location(button1, file$2, 184, 12, 5613);
    			attr_dev(div4, "class", "two columns");
    			add_location(div4, file$2, 183, 8, 5574);
    			attr_dev(div5, "class", "row");
    			set_style(div5, "margin-top", "15%");
    			add_location(div5, file$2, 164, 4, 4723);
    			add_location(th0, file$2, 193, 24, 5933);
    			add_location(th1, file$2, 194, 24, 5975);
    			add_location(tr0, file$2, 192, 20, 5903);
    			add_location(thead, file$2, 191, 16, 5874);
    			add_location(td0, file$2, 206, 24, 6494);
    			attr_dev(td1, "id", "AuMgIVUHfSHpDpgMAAAB");
    			set_style(td1, "color", "#FCA311");
    			add_location(td1, file$2, 207, 24, 6536);
    			add_location(tr1, file$2, 205, 20, 6464);
    			attr_dev(tbody, "id", "playerlist");
    			add_location(tbody, file$2, 197, 16, 6065);
    			attr_dev(table, "class", "u-full-width");
    			add_location(table, file$2, 190, 12, 5828);
    			attr_dev(div6, "class", "four columns");
    			add_location(div6, file$2, 189, 8, 5788);
    			add_location(h40, file$2, 213, 12, 6744);
    			attr_dev(div7, "class", "four columns");
    			add_location(div7, file$2, 212, 8, 6704);
    			add_location(h41, file$2, 216, 12, 6821);
    			attr_dev(div8, "class", "three columns");
    			add_location(div8, file$2, 215, 8, 6780);
    			attr_dev(div9, "class", "row");
    			set_style(div9, "margin-top", "5%");
    			add_location(div9, file$2, 188, 4, 5737);
    			attr_dev(div10, "class", "row");
    			set_style(div10, "margin-top", "5%");
    			add_location(div10, file$2, 220, 4, 6867);
    			attr_dev(div11, "class", "row lowerrow");
    			add_location(div11, file$2, 225, 4, 7075);
    			attr_dev(div12, "class", "content");
    			add_location(div12, file$2, 163, 0, 4688);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
