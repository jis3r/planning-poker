    ...
    function create_else_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 44, 24, 1569);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 42, 24, 1411);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "autocomplete", "off");
    			input0.required = true;
    			add_location(input0, file$8, 50, 12, 1906);
    			attr_dev(label0, "for", "usernameInput");
    			add_location(label0, file$8, 51, 12, 2106);
    			attr_dev(div0, "class", "five columns");
    			add_location(div0, file$8, 49, 8, 1866);
    			...
    			add_location(input1, file$8, 54, 12, 2234);
    			attr_dev(label1, "for", "roomIdInput");
    			add_location(label1, file$8, 55, 12, 2422);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$8, 53, 8, 2194);
    			attr_dev(button, "class", "button-primary button-submit u-full-width");
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "id", "submitButton");
    			set_style(button, "transition", "500ms");
    			add_location(button, file$8, 58, 12, 2547);
    			attr_dev(div2, "class", "three columns");
    			add_location(div2, file$8, 57, 8, 2506);
    			attr_dev(div3, "class", "row");
    			set_style(div3, "margin-top", "15%");
    			add_location(div3, file$8, 48, 4, 1806);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "autocomplete", "off");
    			input0.required = true;
    			add_location(input0, file$8, 39, 12, 1173);
    			attr_dev(label, "id", "usernameLabel");
    			attr_dev(label, "for", "usernameInput");
    			add_location(label, file$8, 40, 12, 1373);
    			attr_dev(input1, "type", "hidden");
    			attr_dev(input1, "name", "room");
    			attr_dev(input1, "id", "roomIDInput");
    			add_location(input1, file$8, 41, 12, 1468);
    			attr_dev(div0, "class", "nine columns");
    			add_location(div0, file$8, 38, 8, 1133);
    			attr_dev(button, "class", "button-primary button-submit u-full-width");
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "id", "submitButton");
    			set_style(button, "transition", "500ms");
    			add_location(button, file$8, 44, 12, 1614);
    			attr_dev(div1, "class", "three columns");
    			add_location(div1, file$8, 43, 8, 1573);
    			attr_dev(div2, "class", "row");
    			set_style(div2, "margin-top", "15%");
    			add_location(div2, file$8, 37, 4, 1073);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div0);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$2, 160, 16, 4658);
    			attr_dev(div0, "class", "copyicon u-pull-left");
    			add_location(div0, file$2, 159, 12, 4606);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$2, 157, 8, 4524);
    			attr_dev(div2, "class", "four columns");
    			attr_dev(div2, "id", "bannerfield");
    			add_location(div2, file$2, 163, 8, 4762);
    			...
    			add_location(img1, file$2, 172, 16, 5192);
    			attr_dev(button0, "class", "button-primary-join u-full-width");
    			set_style(button0, "display", "grid");
    			set_style(button0, "place-items", "center");
    			add_location(button0, file$2, 171, 12, 5058);
    			attr_dev(div3, "class", "two columns");
    			add_location(div3, file$2, 170, 8, 5019);
    			attr_dev(button1, "class", "button-primary-negative u-full-width");
    			add_location(button1, file$2, 176, 12, 5339);
    			attr_dev(div4, "class", "two columns");
    			add_location(div4, file$2, 175, 8, 5300);
    			attr_dev(div5, "class", "row");
    			set_style(div5, "margin-top", "15%");
    			add_location(div5, file$2, 156, 4, 4472);
    			add_location(th0, file$2, 185, 24, 5659);
    			add_location(th1, file$2, 186, 24, 5701);
    			add_location(tr0, file$2, 184, 20, 5629);
    			add_location(thead, file$2, 183, 16, 5600);
    			add_location(td0, file$2, 198, 24, 6220);
    			attr_dev(td1, "id", "AuMgIVUHfSHpDpgMAAAB");
    			set_style(td1, "color", "#FCA311");
    			add_location(td1, file$2, 199, 24, 6262);
    			add_location(tr1, file$2, 197, 20, 6190);
    			attr_dev(tbody, "id", "playerlist");
    			add_location(tbody, file$2, 189, 16, 5791);
    			attr_dev(table, "class", "u-full-width");
    			add_location(table, file$2, 182, 12, 5554);
    			attr_dev(div6, "class", "four columns");
    			add_location(div6, file$2, 181, 8, 5514);
    			add_location(h40, file$2, 205, 12, 6470);
    			attr_dev(div7, "class", "four columns");
    			add_location(div7, file$2, 204, 8, 6430);
    			add_location(h41, file$2, 208, 12, 6547);
    			attr_dev(div8, "class", "three columns");
    			add_location(div8, file$2, 207, 8, 6506);
    			attr_dev(div9, "class", "row");
    			set_style(div9, "margin-top", "5%");
    			add_location(div9, file$2, 180, 4, 5463);
    			attr_dev(div10, "class", "row");
    			set_style(div10, "margin-top", "5%");
    			add_location(div10, file$2, 212, 4, 6593);
    			attr_dev(div11, "class", "row lowerrow");
    			add_location(div11, file$2, 217, 4, 6801);
    			attr_dev(div12, "class", "content");
    			add_location(div12, file$2, 155, 0, 4437);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
