...
var app = (function () {
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$2, 200, 28, 6142);
    			add_location(th1, file$2, 201, 28, 6188);
    			add_location(tr0, file$2, 199, 24, 6108);
    			add_location(thead, file$2, 198, 20, 6075);
    			add_location(td0, file$2, 213, 28, 6743);
    			attr_dev(td1, "id", "AuMgIVUHfSHpDpgMAAAB");
    			set_style(td1, "color", "#FCA311");
    			add_location(td1, file$2, 214, 28, 6789);
    			add_location(tr1, file$2, 212, 24, 6709);
    			attr_dev(tbody, "id", "playerlist");
    			add_location(tbody, file$2, 204, 20, 6290);
    			attr_dev(table, "class", "u-full-width");
    			add_location(table, file$2, 197, 16, 6025);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h4 = element("h4");
    			add_location(h4, file$2, 195, 16, 5976);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h4, anchor);
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th, file$2, 230, 28, 7315);
    			add_location(tr, file$2, 229, 24, 7281);
    			add_location(thead, file$2, 228, 20, 7248);
    			attr_dev(tbody, "id", "spectatorlist");
    			add_location(tbody, file$2, 233, 20, 7417);
    			attr_dev(table, "class", "u-full-width");
    			add_location(table, file$2, 227, 16, 7198);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, table, anchor);
    			append_dev(table, thead);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h4 = element("h4");
    			add_location(h4, file$2, 225, 16, 7149);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h4, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 247, 8, 7919);
    			attr_dev(div1, "class", "row lowerrow");
    			add_location(div1, file$2, 252, 8, 8151);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 171, 8, 4972);
    			attr_dev(div1, "class", "four columns");
    			attr_dev(div1, "id", "bannerfield");
    			add_location(div1, file$2, 174, 8, 5087);
    			attr_dev(button0, "class", "button-primary-join u-full-width");
    			set_style(button0, "display", "grid");
    			set_style(button0, "place-items", "center");
    			attr_dev(button0, "onclick", "this.blur();");
    			add_location(button0, file$2, 182, 12, 5383);
    			attr_dev(div2, "class", "two columns");
    			add_location(div2, file$2, 181, 8, 5344);
    			attr_dev(button1, "class", "button-primary-negative u-full-width");
    			add_location(button1, file$2, 188, 12, 5717);
    			attr_dev(div3, "class", "two columns");
    			add_location(div3, file$2, 187, 8, 5678);
    			attr_dev(div4, "class", "row");
    			set_style(div4, "margin-top", "15%");
    			add_location(div4, file$2, 170, 4, 4920);
    			attr_dev(div5, "class", "four columns");
    			add_location(div5, file$2, 193, 8, 5892);
    			add_location(h4, file$2, 221, 12, 7027);
    			attr_dev(div6, "class", "six columns");
    			add_location(div6, file$2, 220, 8, 6988);
    			attr_dev(div7, "class", "two columns");
    			add_location(div7, file$2, 223, 8, 7063);
    			attr_dev(div8, "class", "row");
    			set_style(div8, "margin-top", "5%");
    			add_location(div8, file$2, 192, 4, 5841);
    			attr_dev(div9, "class", "content");
    			add_location(div9, file$2, 169, 0, 4885);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
