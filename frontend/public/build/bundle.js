...
var app = (function (exports) {
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 43, 24, 1523);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 41, 24, 1365);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$9, 24, 8, 626);
    			attr_dev(label, "id", "usernameLabel");
    			attr_dev(label, "for", "usernameInput");
    			add_location(label, file$9, 25, 8, 822);
    			attr_dev(input1, "type", "hidden");
    			attr_dev(input1, "name", "room");
    			attr_dev(input1, "id", "roomIDInput");
    			add_location(input1, file$9, 26, 8, 913);
    			attr_dev(div0, "class", "nine columns");
    			add_location(div0, file$9, 23, 4, 590);
    			...
    			add_location(button, file$9, 29, 8, 1047);
    			attr_dev(div1, "class", "three columns");
    			add_location(div1, file$9, 28, 4, 1010);
    			attr_dev(div2, "class", "row");
    			set_style(div2, "margin-top", "15%");
    			add_location(div2, file$9, 22, 0, 534);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "autocomplete", "off");
    			input0.required = true;
    			add_location(input0, file$8, 40, 8, 1044);
    			attr_dev(label0, "for", "usernameInput");
    			add_location(label0, file$8, 41, 8, 1240);
    			attr_dev(div0, "class", "five columns");
    			add_location(div0, file$8, 39, 4, 1008);
    			...
    			add_location(input1, file$8, 44, 8, 1356);
    			attr_dev(label1, "for", "roomIdInput");
    			add_location(label1, file$8, 45, 8, 1540);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$8, 43, 4, 1320);
    			attr_dev(button, "class", "button-primary button-submit u-full-width");
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "id", "submitButton");
    			set_style(button, "transition", "500ms");
    			add_location(button, file$8, 48, 8, 1653);
    			attr_dev(div2, "class", "three columns");
    			add_location(div2, file$8, 47, 4, 1616);
    			attr_dev(div3, "class", "row");
    			set_style(div3, "margin-top", "15%");
    			add_location(div3, file$8, 38, 0, 952);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("params" in $$props) $$invalidate(2, params = $$props.params);
    		if ("userdata" in $$props) $$invalidate(0, userdata = $$props.userdata);
    		if ("hasID" in $$props) hasID = $$props.hasID;
    	};
    	...
    	return [userdata, validate, params, input0_input_handler, input1_input_handler];
    }

    class Join extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { params: 2 });
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$6, 10, 4, 209);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$4, 21, 16, 662);
    			attr_dev(div2, "class", "six columns");
    			add_location(div2, file$4, 20, 12, 619);
    			attr_dev(button1, "class", "button-primary-negative u-full-width");
    			add_location(button1, file$4, 24, 16, 817);
    			attr_dev(div3, "class", "six columns");
    			add_location(div3, file$4, 23, 12, 774);
    ...
    function create_each_block_2(ctx) {
    	...
    	userdetails = new Userdetails({
    			props: {
    				name: /*user*/ ctx[24].username,
    				id: /*user*/ ctx[24].id,
    				estimation: /*user*/ ctx[24].estimation,
    				isReady: /*user*/ ctx[24].isReady,
    				socketid: socket.id
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*allUsers*/ 8) userdetails_changes.name = /*user*/ ctx[24].username;
    			if (dirty & /*allUsers*/ 8) userdetails_changes.id = /*user*/ ctx[24].id;
    			if (dirty & /*allUsers*/ 8) userdetails_changes.estimation = /*user*/ ctx[24].estimation;
    			if (dirty & /*allUsers*/ 8) userdetails_changes.isReady = /*user*/ ctx[24].isReady;
    ...
    // (206:8) {#each firstRowValues as currentValue}
    function create_each_block_1(ctx) {
    	let button_estimation;
    	let current;

    	button_estimation = new Button_Estimation({
    			props: { value: /*currentValue*/ ctx[19] },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(206:8) {#each firstRowValues as currentValue}",
    		ctx
    	});
    ...
    // (211:8) {#each secondRowValues as currentValue}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(211:8) {#each secondRowValues as currentValue}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	roomid = new RoomID({
    			props: { id: /*params*/ ctx[0].id || "00000" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$2, 152, 16, 4313);
    			attr_dev(div0, "class", "copyicon u-pull-left");
    			add_location(div0, file$2, 151, 12, 4261);
    			attr_dev(div1, "class", "four columns");
    			add_location(div1, file$2, 149, 8, 4172);
    			attr_dev(div2, "class", "four columns");
    			attr_dev(div2, "id", "bannerfield");
    			add_location(div2, file$2, 155, 8, 4417);
    			...
    			add_location(img1, file$2, 164, 16, 4847);
    			attr_dev(button0, "class", "button-primary-join u-full-width");
    			set_style(button0, "display", "grid");
    			set_style(button0, "place-items", "center");
    			add_location(button0, file$2, 163, 12, 4713);
    			attr_dev(div3, "class", "two columns");
    			add_location(div3, file$2, 162, 8, 4674);
    			attr_dev(button1, "class", "button-primary-negative u-full-width");
    			add_location(button1, file$2, 168, 12, 4994);
    			attr_dev(div4, "class", "two columns");
    			add_location(div4, file$2, 167, 8, 4955);
    			attr_dev(div5, "class", "row");
    			set_style(div5, "margin-top", "15%");
    			add_location(div5, file$2, 148, 4, 4120);
    			add_location(th0, file$2, 177, 24, 5314);
    			add_location(th1, file$2, 178, 24, 5356);
    			add_location(tr0, file$2, 176, 20, 5284);
    			add_location(thead, file$2, 175, 16, 5255);
    			add_location(td0, file$2, 190, 24, 5875);
    			attr_dev(td1, "id", "AuMgIVUHfSHpDpgMAAAB");
    			set_style(td1, "color", "#FCA311");
    			add_location(td1, file$2, 191, 24, 5917);
    			add_location(tr1, file$2, 189, 20, 5845);
    			attr_dev(tbody, "id", "playerlist");
    			add_location(tbody, file$2, 181, 16, 5446);
    			attr_dev(table, "class", "u-full-width");
    			add_location(table, file$2, 174, 12, 5209);
    			attr_dev(div6, "class", "four columns");
    			add_location(div6, file$2, 173, 8, 5169);
    			add_location(h40, file$2, 197, 12, 6125);
    			attr_dev(div7, "class", "four columns");
    			add_location(div7, file$2, 196, 8, 6085);
    			add_location(h41, file$2, 200, 12, 6202);
    			attr_dev(div8, "class", "three columns");
    			add_location(div8, file$2, 199, 8, 6161);
    			attr_dev(div9, "class", "row");
    			set_style(div9, "margin-top", "5%");
    			add_location(div9, file$2, 172, 4, 5118);
    			attr_dev(div10, "class", "row");
    			set_style(div10, "margin-top", "5%");
    			add_location(div10, file$2, 204, 4, 6248);
    			attr_dev(div11, "class", "row lowerrow");
    			add_location(div11, file$2, 209, 4, 6456);
    			attr_dev(div12, "class", "content");
    			add_location(div12, file$2, 147, 0, 4085);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*params*/ 1) roomid_changes.id = /*params*/ ctx[0].id || "00000";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-1rg0u4b");
    ...
    exports.app = app;
    exports.buttonPulse = buttonPulse;
